...
# ref: http://zhanzhang.baidu.com/linksubmit/index?site=http://eastmanjian.cn/

curl -H 'Content-Type:text/plain' --data-binary @sitemap.txt "http://data.zz.baidu.com/urls?site=eastmanjian.cn&token=IzOfDAt7CZZuLJmm"
